...
export var AXIS_SHAPE = PropTypes.shape({
  ...
  x: PropTypes.shape({
    ...
    tick: PropTypes.shape({
      ...
      count: PropTypes.number,
      culling: PropTypes.oneOfType([PropTypes.bool, PropTypes.shape({
        max: PropTypes.number
      })]),
      fit: PropTypes.bool,
...
export var BAR_SHAPE = PropTypes.shape({
  ...
  radius: PropTypes.oneOfType([PropTypes.number, PropTypes.shape({
...
export var DATA_SHAPE = PropTypes.shape({
  ...
  type: PropTypes.oneOf(['area', 'area-line-range', 'area-range', 'area-spline', 'area-step', 'bar', 'bubble', 'donut', 'gauge', 'line', 'pie', 'radar', 'scatter', 'spline']),
...
export var RADAR_SHAPE = PropTypes.shape({
...
export var TOOLTIP_SHAPE = PropTypes.shape({
  ...
  linked: PropTypes.oneOfType([PropTypes.bool, PropTypes.shape({
...
export var ZOOM_SHAPE = PropTypes.shape({
  enabled: PropTypes.oneOfType([PropTypes.bool, PropTypes.shape({
    type: PropTypes.string
  })]),
  ...
  resetButton: PropTypes.oneOfType([PropTypes.bool, PropTypes.shape({
    text: PropTypes.string
  })]),
  x: PropTypes.shape({
    max: PropTypes.number,
